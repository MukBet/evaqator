      ...
      return (
        ...
        <div style={priceStyles.container} >
          ...
          <div style={{ textAlign:'left',}} >
            <h3 className="info-row-price" style={{ fontWeight:'bold', border:'2px solid red', borderRadius:'10px', padding: '10px 10px 10px 20px'}}>
            &#9757; По місту 500 грн замовлення + 20 грн / км в обидві сторони (до 100 км).
            </h3>
            <h3 className="info-row-price">
